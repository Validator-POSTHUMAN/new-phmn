...
- High-signal English infographic: `graphs/phmn_incident_high_signal_flow.svg`
...
3. Update `PHMN_INCIDENT_FALSE_POSITIVE_REVIEW_2026-06-18.md` and `PHMN_INCIDENT_FALSE_POSITIVE_REVIEW_RU_2026-06-18.md` if a new false-positive pattern appears.
